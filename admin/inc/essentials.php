...
define('SITE_URL', 'http://127.0.0.1/zahir/');
...
define('UPLOAD_IMAGE_PATH', $_SERVER['DOCUMENT_ROOT'] . '/zahir/image/');
...
//sendgrid api key
define('SENDGRID_API_KEY', "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");
...
function uploadSVGImage($image, $folder)
{
  ...
  if (!in_array($img_mime, $valid_mime)) {
    ...
    return 'inv_size'; //invalide size greater than 1mb
  } else {
    $ext = pathinfo($image['name'], PATHINFO_EXTENSION);
    $rname = 'IMG_' . random_int(11111, 99999) . ".$ext";
