  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-7 col-md-12 px-4">
        <div id="roomControls" class="carousel slide" data-bs-ride="carousel">
          ...
          <button class="carousel-control-prev" type="button" data-bs-target="#roomControls" data-bs-slide="prev">
            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
            <span class="visually-hidden">Previous</span>
          </button>
          <button class="carousel-control-next" type="button" data-bs-target="#roomControls" data-bs-slide="next">
        ...
        <div class="card mb-4 border-0 shadow-sm rounded-3">
          <div class="card-body">
            ...
            if (!$settings_r['shutdown']) {
              ...
              echo <<<book
                <button onclick='checkLogingToBook($login, {$room_data['id']})' class="btn w-100 text-white custom-bg mb-1 shadow-none">Book Now</button>
              book;
            }
