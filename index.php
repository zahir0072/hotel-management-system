...
<body class="bg-light">
    ...
    <div class="row">
      ...
      while ($room_data = mysqli_fetch_assoc($room_res)) {
        ...
        if (!$settings_r['shutdown']) {
          ...
          $book_btn = "<button onclick='checkLogingToBook($login, {$room_data['id']})' class='btn btn-sm text-white custom-bg'>Book Now</button>";
        }
  ...
  <div class="container mb-4">
    <div class="row">
      <div class="col-lg-8 col-md-8 p-4 mb-lg-0 mb-3 bg-white rounded">
        <iframe class="w-100 rounded" src="<?php echo $contact_r['iframe'] ?>" height="350px" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
      </div>
  ...
  <div class="modal fade" id="recoveryModel" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <form id="recovery-form">
          ...
          <div class="modal-body">
            ...
            <div class="mb-2 text-end">
              ...
              <button type="sbmit" class="btn btn-dark shadow-none">SUBMIT</button>
            </div>
          </div>
        </form>
      </div>
