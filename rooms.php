        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-white rounded shadow">
          <div class="container-fluid flex-lg-column align-items-stretch">
            ...
            <button class="navbar-toggler shadow-none" type="button" data-bs-toggle="collapse"
              data-bs-target="#filterDropdowe" aria-controls="navbarNav" aria-expanded="false"
              aria-label="Toggle navigation">
              <span class="navbar-toggler-icon"></span>
            </button>
            <div class="collapse navbar-collapse flex-column align-items-stretch mt-2" id="filterDropdowe">
              <!-- Check Avaikablity -->
              <div class="border bg-light p-3 rounded mb-3">
                <h5 class=" align-items-center justify-content-between mb-3" style="font-size: 18px;">
              ...
              <div class="border bg-light p-3 rounded mb-3">
                ...
                <div class="d-flex">
                  <div class="me-3">
                    ...
                    <input type="number" id="adults" min="1" value="<?php echo $adult_default ?>" oninput="guests_filter()" class="form-control shadow-none mb-3">
                  </div>
                  <div>
                    <label class="form-label">Children</label>
                    <input type="number" id="children" min="1" value="<?php echo $children_default ?>" oninput="guests_filter()" class="form-control shadow-none mb-3">
                  </div>
                </div>
              </div>
            </div>
    ...
    function fetch_rooms() {
      ...
      if (get_facilities.length > 0) {
        get_facilities.forEach((facility) => {
          facility_list.facilities.push(facility.value); // <-- fix here
        });
      ...
      xhr.open("GET", "ajax/rooms.php?fetch_rooms&chk_avail=" + chk_avail + "&guests=" + guests + "&facility_list=" + encodeURIComponent(facility_list), true);
