        ...
        <div class="card mb-4 border-0 shadow-sm rounded-3">
          <div class="card-body">
            <form action="book_now.php" method="POST" id="booking_form">
              <h5 class="mb-3">BOOKING DETALIS</h5>
              <div class="row">
                <div class="col-md-6 mb-3">
                  <label class="form-label ps-0 mb-1">Name</label>
                  <input name="name" type="name" value="<?php echo $user_data['name'] ?>" class="form-control shadow-none" required>
                </div>
                <div class="col-md-6 mb-3">
                  <label class="form-label ps-0">Phone Number</label>
                  <input name="phonenum" type="name" value="<?php echo $user_data['phonenum'] ?>" class="form-control shadow-none" required>
                </div>
                <div class="col-md-12 mb-3">
                  <label class="form-label ps-0">Address</label>
                  <textarea name="address" class="form-control shadow-none" rows="1" required><?php echo $user_data['address'] ?></textarea>
                </div>
                <div class="col-md-6 mb-3">
                  <label class="form-label ps-0">Check-in</label>
                  <input name="checkin" onchange="check_availability()" type="date" class="form-control shadow-none" required>
                </div>
                <div class="col-md-6 mb-3">
                  <label class="form-label ps-0">Check-out</label>
                ...
                <div class="col-12">
                  ...
                  <button name="book_now" class="btn w-100 text-white custom-bg shadow-none mb-1" disabled>Book</button>
                </div>
              </div>
            </form>
          </div>
